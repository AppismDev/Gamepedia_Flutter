...
part of 'game_card_viewmodel.dart';
...
mixin _$GameCardViewModel on _GameCardViewModelBase, Store {
  Computed<bool>? _$loadingImageComputed;

  @override
  bool get loadingImage =>
      (_$loadingImageComputed ??= Computed<bool>(() => super.loadingImage,
              name: '_GameCardViewModelBase.loadingImage'))
          .value;

  final _$_loadingImageAtom =
      Atom(name: '_GameCardViewModelBase._loadingImage');
  ...
  final _$gameCoverModelAtom =
      Atom(name: '_GameCardViewModelBase.gameCoverModel');
  ...
  final _$getCoverAsyncAction = AsyncAction('_GameCardViewModelBase.getCover');
